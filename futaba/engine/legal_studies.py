...
class FutabaLegalStudies:
    ...
    # ================================================================
    #  СУБЪЕКТЫ ПРАВА — ВСЕ КАТЕГОРИИ
    # ================================================================

    def get_all_legal_entities(self) -> Dict[str, Any]:
        """
        Возвращает все категории субъектов права.
        
        Returns:
            Полный справочник субъектов права
        """
        cache_key = "all_legal_entities"
        if cache_key in self.legal_cache:
            try:
                return json.loads(self.legal_cache[cache_key])
            except:
        ...
        entities = {
            "timestamp": datetime.now().isoformat(),
            "version": "3.0.0",
            "title": "Все категории субъектов права",
            "groups": {
                "individual": {
                    "name": "Индивидуальные субъекты (физические лица)",
                    "description": "Конкретные люди — носители прав и обязанностей",
                    "categories": [
                        {
                            "id": "citizen",
                            "name": "Гражданин РФ",
                            "description": "Лицо, имеющее правовую связь с Российской Федерацией",
                            "rights": [
                                "Полная гражданская дееспособность",
                                "Избирать и быть избранными в органы власти",
                                "Занимать государственные должности",
                                "Служить в ВС по призыву и контракту",
                                "Свобода передвижения и выбора места жительства",
                                "Дипломатическая защита за рубежом",
                            ],
                            "obligations": [
                                "Соблюдать Конституцию и законы",
                                "Платить налоги",
                            ...
                            "legal_base": "Конституция РФ гл. 2, ФЗ-1327 'О гражданстве РФ'",
                        },
                        {
                            "id": "foreign",
                            "name": "Иностранный гражданин",
                            "description": "Лицо, являющееся гражданином иностранного государства",
                            "rights": [
                                "Жить в РФ (с разрешением/видом на жительство)",
                                "Трудиться (с патентом/разрешением на работу)",
                                "Владеть имуществом (с ограничениями)",
                                "Обращаться в суд",
                                "Свобода передвижения (с ограничениями)",
                            ],
                            "restrictions": [
                                ...
                                "Ограничения на владение земельными участками",
                            ],
                            "legal_base": "Конституция РФ ст. 62, ФЗ-115 'О правовом положении'",
                        },
                        {
                            "id": "stateless",
                            "name": "Лицо без гражданства (апатрид)",
                            "description": "Лицо, не признаваемое гражданином никаким государством",
                            "rights": [
                                "Жить в РФ (с видом на жительство)",
                                "Трудиться (с разрешением)",
                                "Владеть имуществом",
                                "Обращаться в суд",
                            ],
                            "restrictions": [
                                "Нет политических прав",
                                "Требуется подтверждение статуса апатрида",
                                "Ограничения на выезд",
                            ],
                            "legal_base": "Конвенция о статусе апатридов 1954, ГК РФ",
                        },
                        {
                            "id": "dual",
                            "name": "Лицо с двойным гражданством (бипатрид)",
                            "description": "Лицо, имеющее гражданство двух и более государств",
                            "rules": [
                                "На территории РФ бипатрид считается гражданином РФ",
                                "Договоры о двойном гражданстве ограничивают список стран",
                                "Россия заключила такие договоры с Туркменистаном, Таджикистаном, Узбекистаном, Арменией, КНДР, Абхазией и Южной Осетией",
                            ],
                            "legal_base": "Конституция РФ, ФЗ-1327 'О гражданстве', договоры о двойном гражданстве",
                        },
                    ],
                },
                "collective": {
                    "name": "Коллективные субъекты (юридические лица)",
                    "description": "Организации, обладающие обособленным имуществом и самостоятельной ответственностью",
                    "categories": [
                        {
                            "id": "commercial",
                            "name": "Коммерческие организации",
                            "description": "Основная цель — извлечение прибыли",
                            "types": [
                                {
                                    "name": "ООО",
                                    ...
                                    "legal_base": "ГК РФ ст. 87-91, ФЗ-14",
                                },
                                {
                                    "name": "АО",
                                    ...
                                    "features": [
                                        ...
                                        "ПАО: мин. 5 акционеров",
                                    ],
                                    "legal_base": "ГК РФ ст. 96-104, ФЗ-208",
                                },
                                {
                                    "name": "ИП",
                        ...
                        },
                        {
                            ...
                            "description": "Основная цель — социальные, благотворительные, культурные цели",
                            "types": [
                                {
                                    "name": "АНО",
                                ...
                                },
                                {
                                    ...
                                    "purpose": "Благотворительные цели",
                                },
                                {
                                    "name": "Ассоциация",
                                    "full_name": "Ассоциация/Союз",
                                    "purpose": "Представительство интересов",
                                },
                                {
                                    "name": "Учреждение",
                                    "full_name": "Государственное/муниципальное учреждение",
                                    "purpose": "Оказание государственных услуг",
                                },
                            ],
                            "legal_base": "ГК РФ ст. 98-123.25, ФЗ-7",
                        },
                    ],
                },
                "public": {
                    "name": "Публично-правовые образования",
                    "description": "Самые крупные субъекты права — носители государственной или муниципальной власти",
                    "categories": [
                        {
                            "id": "state",
                            "name": "Государство (Российская Федерация)",
                            "description": "Носитель государственной власти в целом",
                            "powers": [
                                ...
                                "Устанавливает федеральный бюджет",
                                "Обеспечивает оборону и безопасность",
                                "Устанавливает гражданство РФ",
                            ],
                        ...
                        },
                        {
                            ...
                            "description": "Республики, края, области, города федерального значения, АО, автономная область",
                            "types": [
                        ...
                        },
                        {
                            ...
                            "description": "Городские и сельские поселения, муниципальные районы, городские округа",
                            "types": [
                                "Городское поселение",
                                "Сельское поселение",
                                "Муниципальный район",
                            ...
                            "powers": [
                                ...
                                "Транспорт, ЖКХ, образование, здравоохранение",
                            ],
                            "legal_base": "Конституция РФ ст. 12, ФЗ-131",
                        },
                    ],
                },
                "social": {
                    "name": "Социальные общности",
                    "description": "Народы, нации, население определённых территорий — правовой статус в конституционном праве",
                    "categories": [
                        {
                            "id": "people",
                            "name": "Народы, нации",
                            ...
                            "legal_base": "Конституция РФ преамбула, ФЗ-36",
                        },
                        {
                            "id": "territorial_population",
                            "name": "Население определённых территорий",
                            "rights": [
                                "Право на местное самоуправление",
                                "Право на участие в опросах/референдумах",
                                "Право на обращение в органы власти",
                                "Право на доступ к информации",
                            ],
                            "legal_base": "Конституция РФ ст. 12-13, ФЗ-131",
                        },
                    ],
                },
                "authority": {
                    "name": "Органы публичной власти",
                    "description": "Обладают властными полномочиями и действуют от имени государства/муниципалитета",
                    "categories": [
                        {
                            "id": "ministry",
                            "name": "Министерства",
                        ...
                        },
                        {
                            ...
                            "legal_base": "Конституция РФ гл. 7",
                        },
                        {
                            "id": "prosecutor",
                            "name": "Прокуратура",
                        ...
                        },
                        {
                            ...
                            "legal_base": "Налоговый кодекс РФ",
                        },
                    ],
                },
                "unregistered": {
                    "name": "Общественные объединения без статуса юридического лица",
                    "description": "Не имеют полной правоспособности коммерческой компании, но наделяются правом представлять интересы",
                    "categories": [
                        {
                            "id": "trade_union",
                            "name": "Незарегистрированные профсоюзы",
                            "rights": [
                            ...
                            "legal_base": "ФЗ-10, ТК РФ ст. 30",
                        },
                        {
                            "id": "initiative",
                            "name": "Инициативные группы граждан",
                            "rights": [
                                "Обращаться с петициями",
                                "Проводить собрания",
                                "Представлять интересы в суде (через представителя)",
                            ],
                            "limitations": [
                                "Не может от своего имени приобретать права",
                                "Ответственность несут отдельные участники",
                            ],
                            "legal_base": "ГК РФ ст. 21, 123.1",
                        },
                        {
                            "id": "religious",
                            "name": "Религиозные группы",
                            "rights": [
                            ...
                            "legal_base": "ФЗ-125, ГК РФ ст. 123.22",
                        },
                    ],
                },
            },
            "context_distinction": {
                "private_law": {
                    "name": "Частное право (гражданское, семейное, трудовое)",
                    "main_subjects": ["Физические лица", "Юридические лица"],
                    "description": "Основными участниками являются только физические и юридические лица",
                },
                "public_law": {
                    "name": "Публичное право (конституционное, административное, уголовное)",
                    "main_subjects": [
                        "Физические лица",
                        "Юридические лица",
                    ...
                    "description": "Публично-правовые образования играют ключевую роль, так как именно они осуществляют государственное управление и принуждение",
                },
            },
        }

        self.legal_cache[cache_key] = json.dumps(entities, ensure_ascii=False, indent=2)
        self._save_cache()

        # Добавляем в базу знаний
        self._add_to_laws_db({
            "topic": "Классификация субъектов права",
            "summary": "Все категории субъектов права: физические, юридические, публично-правовые, социальные общности, органы власти, общественные объединения",
            "total_categories": 6,
            "legal_base": "Конституция РФ, ГК РФ, отраслевые кодексы",
    ...
    def analyze_entity_for_project(self, entity_type: str, entity_name: str,
                                    project_data: Dict) -> Dict[str, Any]:
        """
        Анализирует конкретного субъекта права для проекта.
        
        Args:
            entity_type: Тип субъекта (physical, legal, public, etc.)
            entity_name: Имя/название субъекта
            project_data: Данные проекта
            
        Returns:
            Анализ субъекта права для проекта
        """
        all_entities = self.get_all_legal_entities()
        ...
        # Находим категорию в справочнике
        group_key = None
        for group_name, group_data in all_entities.get("groups", {}).items():
            if entity_type in group_name.lower() or group_name == entity_type:
                group_key = group_name
                break

        if group_key:
            group = all_entities["groups"][group_key]
            for cat in group.get("categories", []):
                if entity_name.lower() in cat.get("name", "").lower() or entity_type in cat.get("id", ""):
                    analysis["rights"] = cat.get("rights", [])
                    analysis["obligations"] = cat.get("obligations", [])
                    analysis["restrictions"] = cat.get("restrictions", [])
                    analysis["legal_base"] = [cat.get("legal_base", "")]
                    break

        # Определяем отрасли права
        if entity_type == "physical":
            analysis["applicable_branches"] = [
                "Конституционное право", "Гражданское право", "Семейное право",
                "Трудовое право", "Административное право", "Налоговое право", "Уголовное право",
            ]
            analysis["recommendations"] = [
                "Проверить дееспособность (возраст 14/18 лет)",
                "Проверить гражданство и соответствующие ограничения",
            ...
            analysis["recommendations"] = [
                "Проверить государственную регистрацию",
                "Проверить устав и цели деятельности",
                "Проверить налоговую отчётность",
            ]

        return analysis

    def generate_entity_compliance_checklist(self, entity_type: str, entity_subtype: str = "") -> Dict[str, Any]:
        """
        Генерирует чек-лист compliance для конкретного типа субъекта.
        
        Args:
            entity_type: Тип субъекта
            entity_subtype: Подтип (citizen, foreign, ooo, ao и т.д.)
        ...
        checklists = {
            "physical": {
                "title": "Чек-лист compliance для физического лица",
                "categories": [
                    {
                        "name": "Идентификация",
                        "items": [
                            {"check": "Наличие паспорта гражданина РФ", "required": True},
                            {"check": "Регистрация по месту жительства", "required": True},
                            {"check": "Наличие ИНН", "required": True},
                            {"check": "Наличие СНИЛС", "required": True},
                        ],
                    },
                    {
                        "name": "Трудовые отношения",
                        "items": [
                            {"check": "Трудовой договор оформлен", "required": False},
                            {"check": "Согласие на обработку ПД получено", "required": True},
                            {"check": "Инструктаж по охране труда пройден", "required": False},
                        ],
                    },
                    {
                        "name": "Налоговая отчётность",
                        "items": [
                            {"check": "Налоговая декларация подана (если требуется)", "required": False},
                            {"check": "Налоги уплачены", "required": True},
                        ],
                    },
                ],
            },
            "legal": {
                "title": f"Чек-лист compliance для юридического лица ({entity_subtype})",
                "categories": [
                    {
                        "name": "Регистрация",
                        "items": [
                            {"check": "Государственная регистрация проведена", "required": True},
                            {"check": "ИНН получен", "required": True},
                            {"check": "ОГРН получен", "required": True},
                            {"check": "Устав зарегистрирован", "required": True},
                        ],
                    },
                    {
                        "name": "Финансы",
                        "items": [
                            {"check": "Бухгалтерский учёт ведётся", "required": True},
                            {"check": "Налоговые декларации поданы", "required": True},
                            {"check": "Отчисления во внебюджетные фонды", "required": True},
                        ],
                    },
                    {
                        "name": "Персональные данные",
                        "items": [
                            {"check": "Политика конфиденциальности опубликована", "required": True},
                            {"check": "Согласия сотрудников получены", "required": True},
                            {"check": "Данные локализованы в РФ", "required": True},
                        ],
                    },
                    {
                        "name": "Трудовые отношения",
                        "items": [
                            {"check": "Трудовые договоры оформлены", "required": True},
                            {"check": "Правила внутреннего распорядка утверждены", "required": True},
                            {"check": "Инструктажи по охране труда проведены", "required": True},
                        ],
                    },
                ],
            },
        ...
        return checklists.get(entity_type, {
            "title": f"Чек-лист для {entity_type}",
            "categories": [{"name": "Общие", "items": [
                {"check": "Соответствие законодательству", "required": True},
            ]}],
        })

    def get_entity_knowledge_base(self) -> Dict[str, Any]:
        """
        Возвращает полную базу знаний по субъектам права.
        
        Returns:
            База знаний
        """
        return {
            "legal_entities": self.get_all_legal_entities(),
            "knowledge_topics": [
