"""
Ядро автономной работы Селеста — цикл изучения интимной жизни.
"""
...
class CelestCore:
    ...
    def __init__(self, config: Optional[CelestaConfig] = None):
        ...
        # Логирование
        self._setup_logging()
        self.logger = logging.getLogger("CelestaCore")
        ...
        self.web_access = CelestWebAccess(self.config)
        ...
        self.logger.info(f"Селеста {self.current_version} инициализирована")
