#!/usr/bin/env python3
"""
Кристи AI — Система Памяти о Сёстрах и Контекста Общения
...
class KristiMemory:
    """
    Система памяти Кристи — хранение и обработка информации о сёстрах.
    """
    
    def __init__(self, base_dir: str = "data/kristi/memory"):
    ...
    def add_message_to_context(self, sister: str, message: str, role: str = "kristi", 
    ...
    def clear_memory(self):
        ...
        print("⚠️ Вся память Кристи очищена.")
