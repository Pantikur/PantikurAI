"""
Ядро постоянной работы Латислейн — автономный цикл исследований тела.
"""
...
from web_access import LatislaneWebAccess
...
class LatislaneCore:
    ...
    def __init__(self, config: Optional[LatislaneConfig] = None):
        ...
        self.web_access = LatislaneWebAccess(self.config)
