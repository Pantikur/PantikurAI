    ...
    def generate_response(self, messages: List[Dict[str, str]], mode: str = "chat") -> str:
        ...
        # === Режим world_gen ===
            ...
            prompt = (
                ...
                "Название: [краткое название мира]\n\n"
                "Описание: [подробное описание мира. Расскажи о его истории, особенностях, атмосфере. Используй тег '{tag}' как ключевую тему. Напиши 3-4 абзаца связного текста, как в художественной книге.]\n\n"
                f"Жанр: {genre}"
            ...
            fallback_desc = (
                f"Это мир в жанре {genre}, где всё пропитано духом {tag if tag else 'тайны'}. "
