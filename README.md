...
| `world_gen`  | Генерация мира: название + подробное описание по жанру и тегу. |
...
### Быстрое обучение (рекомендуется):

```bash
# Полный ретраин со всеми данными
python retrain.py

# С обучением из книг (автономный сбор знаний)
