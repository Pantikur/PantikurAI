...
Research Monitor позволяет запускать, останавливать и наблюдать за процессом исследований **десяти** учёных:
...
- **Аква** — математика, физика, аэродинамика, сопротивление материалов (🌐 интернет)
- **Юи** — сознание, перенос разума, оцифровка души (🌐 интернет)
